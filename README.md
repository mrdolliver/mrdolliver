...
**Technical Training Manager** · **Technical Writer** · **Documentation Specialist**  

With over **20 years of experience** in telecom, networking, and cloud systems, I’ve built training programs and documentation that make complex technology understandable and repeatable. My work bridges the gap between engineers, learners, and business stakeholders — turning technical depth into practical knowledge.

---

## ⚡ At a Glance
- 🧭 20+ years building enterprise-level training and documentation programs  
- 🎓 Certified Technical Trainer (CTT+) · Cloud-Native Certified Associate  
- 🧰 Tools: Markdown · Camtasia · Captivate · Moodle · Linux  
- 🌐 [LinkedIn](https://linkedin.com/in/robert-dolliver) · [GitHub](https://github.com/mrdolliver)

---

## 🚀 Core Expertise
- **Instructional Design** – Curriculum development, e-learning, and blended delivery  
- **Technical Documentation** – Writing clear, structured guides for technical audiences  
- **Learning Systems** – LMS administration, content analytics, and AI-based course narration  
- **Process & Workflow Documentation** – Standardizing internal procedures and best practices  
...
### **DOCSIS Primer**  
Short “video nibble” tutorials for engineers unable to attend live ILT sessions.  
🎥 [Watch sample](https://app.screencast.com/U2oUr1yUZdkZB) — *Runtime: 5:10*  
> Tools: PowerPoint · Camtasia · Audacity  

---

### **Cloud Native & Kubernetes Primer**  
Introductory session on cloud-native architecture for telecom professionals.  
🎥 [Watch sample](https://app.screencast.com/b8jApEZLDT0uO) — *Runtime: 16:34*  
> Tools: PowerPoint · Camtasia · AI Voiceover  

---

### **VCCAP Product Training**  
Full product training with lab-based remote access environments.  
🎥 [Watch sample](https://app.screencast.com/bG0k5FZWnAJV8) — *Runtime: 5:06*  
> Tools: PowerPoint · AI Voiceover · Virtual Lab  

---

## 🖋 Documentation Philosophy  
I believe the best documentation anticipates questions before they’re asked.  
My approach blends **clarity**, **structure**, and **empathy for the learner** — making complex systems understandable, repeatable, and actionable.  
...
> *This README was created to showcase my technical documentation, training, and content development expertise. Feedback and collaboration ideas are always welcome!*
